...
**DClaw Inventory** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8098` (FastAPI)
- **Frontend Port:** `3009` (Next.js)
- **Database:** `dclaw_inventory` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3009`
